...
def create_window_device_keyboard(is_worked: bool = False) -> ReplyKeyboardMarkup:
...
def create_humidifier_device_keyboard(is_worked: bool = False) -> ReplyKeyboardMarkup:
    builder = ReplyKeyboardBuilder()
    ...
    if is_worked:
        ...
        builder.row(KeyboardButton(text='Включить увдажнитель'), width=1)
...
def create_sprinkler_device_keyboard(sprinkler_id: int, is_worked: bool = False) -> ReplyKeyboardMarkup:
    builder = ReplyKeyboardBuilder()
...
def create_emergency_management_keyboard(is_worked: bool = False) -> ReplyKeyboardMarkup:
    builder = ReplyKeyboardBuilder()
